    ...
    <div id="Bloque_container">
        ...
        <nav id="menu">
            ...
            <?php if(!isset($_SESSION['identity'])):?>
                <li class="ingreso"><a href="<?=base_url?>user/vistalogin">Ingresar</a></li>
            <?php endif; ?>    
                <li><a href="<?=base_url?>user/img1">imagen 1</a></li>
                <li><a href="<?=base_url?>user/img2">imagen 2</a></li>
                <li><a href="<?=base_url?>user/img3">imagen 3</a></li>
                <li><a href="<?=base_url?>user/img4">imagen 4</a></li>
